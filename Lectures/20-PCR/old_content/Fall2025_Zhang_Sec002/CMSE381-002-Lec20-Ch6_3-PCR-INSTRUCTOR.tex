...
\textbf{Announcements:}
	\begin{itemize}
		\item \href{https://forms.office.com/r/c5LNyeffiK}{Submit your questions} by Thursday (10/16) 5 pm! 
		\item Exam \#2 on next week!
		\begin{itemize}
...
% \includegraphics[width = 0.5\textwidth]{QRCode_exam2_survey_S25.png}
\end{columns}
...
\begin{itemize}
	\item Why do you want to use the PCs in regression models?
	\begin{itemize}
		\item What assumptions do you have to make for it to be a good idea to use \textbf{principal component regression (PCR)}?
		\item Or conversely, what is a typical bad scenario to use PCR?
	\end{itemize}
	\item How do you implement PCR in Python?
	\item How do you interpret the model coefficients when using PCR?
	\item How do you choose the number of PC to use in PCR?
	\begin{itemize}
		\item Given a figure of, e.g., cross-validation score as a function of the number of PCs, you should be able to choose appropriately and provide rationales in terms of bias-variance tradeoff.
		\item You should be able to generate such figures in Python.
	\end{itemize}
	\item What is the relationship/differences between PCR and feature selection and regularization methods that you learned in this part of the course?
\end{itemize}
\end{frame}
...
\includegraphics[width = 0.8\textwidth, align = c]{Fig6-18a}
\InstructorList{
\item Typical U shape for Test MSE
\item Improve over least square (right most value x=45)
}
\column{.45\textwidth}
\centering
$Y$ is a function of \textbf{2 predictors}
\includegraphics[width = 0.8\textwidth, align = c]{Fig6-18b}
\InstructorList{
\item Typical U shape for Test MSE
\item (slight) improve over least square (right most value x=45)
}
\end{columns}
...
\begin{frame}[c]{Properties of PCR}
	...
	\vfill
	Test your understanding: \href{https://PollEv.com/multiple_choice_polls/2VGAXRSk8kmwbgBeDBAxX/respond}{PollEv}
	\end{frame}
	%--- Next Frame ---%
