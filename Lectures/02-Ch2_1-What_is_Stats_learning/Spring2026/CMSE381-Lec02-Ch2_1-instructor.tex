...
\begin{frame}[t]{Announcements}
	...
	\includegraphics[align = c, width = \textwidth, trim = 0 200 0 0, clip]{Schedule-S26-1.png}
...
\textbf{Next time:}
	...
	\end{itemize}
	\includegraphics[align = c, width = .7\textwidth, trim = 0 170 0 0, clip]{Schedule-S26-1.png}
\column{.5\textwidth}
\centering
