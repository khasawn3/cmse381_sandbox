...
\begin{frame}[t]{Announcements}
	...
	\includegraphics[align = c, width = \textwidth, trim = 0 390 0 0, clip]{Schedule-S24-1.png}
	...
	\begin{itemize}
		...
		\end{itemize}
		\item First homework due Sun Sep 8
...
\begin{columns}
\column{.28\textwidth}
\includegraphics[width=\textwidth]{AdvertisingDataSet-Screenshot.png}
\column{.6\textwidth}
\begin{itemize}
...
Data available at \href{https://msu-cmse-courses.github.io/CMSE381-F24/DataSets/DataSets.html}{msu-cmse-courses.github.io/CMSE381-F24/DataSets/DataSets.html}
...
Example: If we spend \$250 on TV advertising, what do we predict we will we make in sales?
	...
	\includegraphics[width=.7\textwidth,trim = 0 0 700 0, clip]{Fig2-1-WithHatF}
\end{columns}
...
\includegraphics[width=\textwidth, trim = 0 300 0 0, clip]{AdvertisingDataSet-Screenshot.png}

\includegraphics[width=\textwidth,trim = 0 0 720 0, clip]{Fig2-1-WithHatF}
\column{.45\textwidth}
...
\column{.45\textwidth}
\centering
\includegraphics[align = c, width = \textwidth]{ExampleScatter}
...
\column{.4\textwidth}
\centering
\includegraphics[width = \textwidth]{ESLR-Fig2-2.png}
...
\textbf{Pros}
\InstructorList{
\item Easier to estimate paramters than to figure out a completely arbitrary function
}
\column{.4\textwidth}
\textbf{Cons}
\centering
...
\begin{columns}
\column{.4\textwidth}
\includegraphics[width=\textwidth]{Fig2-5}
\column{.4\textwidth}
\includegraphics[width=\textwidth]{Fig2-6}
...
\includegraphics[width=\textwidth]{Fig2-7}
\column{.3\textwidth}
\InstructorList{
...
\includegraphics[height = 2.3in,trim = 0 0 950 0, clip]{Fig2-1}
...
\includegraphics[height = 2.3in]{Fig2-8a}
\end{columns}
...
\textbf{Next time:}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item There will be a quiz next week
		\end{itemize}
		\item Monday Jan 19
		\begin{itemize}
			\item NO CLASS (MLK) !!!!
	...
	\end{itemize}
	\includegraphics[align = c, width = .7\textwidth, trim = 0 370 0 0, clip]{Day01-Schedule1}
% \column{.5\textwidth}
% \centering
