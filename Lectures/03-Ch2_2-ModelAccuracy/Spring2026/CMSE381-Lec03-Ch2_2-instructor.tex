...
\column{.6\textwidth}
\centering
\includegraphics[width = \textwidth]{LinearVsQuadratic}
...
\centering
\includegraphics[width = .4\textwidth]{../Figures/ExampleLinear50pts}
...
\column{.15\textwidth}
\centering
\includegraphics[align = c, width = \textwidth]{FakeData-Sec2-2-MSE}

\column{.45\textwidth}
\centering
\InstructorNotes{\includegraphics[align = c, width = \textwidth]{FakeData-Sec2-2-MSE-Soln}}
\end{columns}
\end{frame}
}
%--- Next Frame ---%
...
\includegraphics[width = \textwidth]{CovidInghamCounty-Jan2022}
\column{.4\textwidth}
\centering
...
\begin{frame}[t]{A more linear example}
	\centering
	\includegraphics[width = .7\textwidth]{Fig2-10}
	\tiny
	\InstructorList{
...
\begin{frame}[t]{A more non-linear example}
	\centering
	\includegraphics[width = .7\textwidth]{Fig2-11}
	\InstructorList{
...
\column{.3\textwidth}
\centering
\includegraphics[width = \textwidth,clip, trim = 0 0 600 0 ]{Fig2-10}
\column{.3\textwidth}
\centering
\includegraphics[width = .8\textwidth,clip, trim = 400 0 400 0 ]{Fig2-12}
\column{.3\textwidth}
\InstructorNotes{
Label the line corresponding to each of the following:
\begin{itemize}
...
\column{.3\textwidth}
\centering
\includegraphics[width = \textwidth,clip, trim = 0 0 600 0 ]{Fig2-11}
\column{.3\textwidth}
\centering
\includegraphics[width = .8\textwidth,clip, trim = 800 0 0 0 ]{Fig2-12}
\column{.3\textwidth}
\InstructorNotes{
Label the line corresponding to each of the following:
\begin{itemize}
