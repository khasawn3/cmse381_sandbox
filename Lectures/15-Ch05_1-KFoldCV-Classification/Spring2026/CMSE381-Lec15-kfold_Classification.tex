...
\begin{frame}[c]{Setup: LOOCV}
    ...
    \includegraphics[alt={Diagram showing the second leave-one-out cross-validation split.},width = \textwidth]{LOOCV-subset1.png}
    \includegraphics[alt={Diagram showing the third leave-one-out cross-validation split.},width = \textwidth]{LOOCV-subset2.png}
    \includegraphics[alt={Diagram showing the fourth leave-one-out cross-validation split.},width = \textwidth]{LOOCV-subset3.png}
    \includegraphics[alt={Diagram showing the fifth leave-one-out cross-validation split.},width = \textwidth]{LOOCV-subset4.png}
	$\vdots$
	\includegraphics[alt={Diagram showing the final leave-one-out cross-validation split.},width = \textwidth]{LOOCV-subset29.png}
	Return
	\begin{equation*}
...
\column{.4\textwidth}
\centering
\includegraphics[alt={Classification plot illustrating data points and the Bayes decision boundary.},width = \textwidth]{Fig5-7a}
\column{.45\textwidth}
\centering
\begin{itemize}
...
\column{.4\textwidth}
\centering
\includegraphics[alt={Classification plot showing data points and the Bayes decision boundary for a second example.},width = \textwidth]{Fig5-7b}
\column{.45\textwidth}
\centering
\begin{itemize}
	\item Purple: Bayes decision boundary.
...
\column{.45\textwidth}
\centering
\includegraphics[alt={Classification plot comparing the Bayes decision boundary and logistic regression fits with different polynomial degrees.},width = \textwidth]{Fig5-7}
\column{.35\textwidth}
\centering
\begin{itemize}
	\item Purple: Bayes decision boundary.
...
\column{.45\textwidth}
\centering
\includegraphics[alt={Plot of training error, test error, and 10-fold cross-validation error versus model degree, used to choose the degree.},width = \textwidth]{Fig5-8a}
\column{.5\textwidth}
\centering
\begin{itemize}
...
\column{.45\textwidth}
\centering
\includegraphics[alt={Plot of training error, test error, and 10-fold cross-validation error used to choose the value of K in classification.},width = \textwidth]{Fig5-8b}
\column{.45\textwidth}
\centering
\begin{itemize}
	\item Test error (brown)
