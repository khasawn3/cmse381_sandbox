...
\author[Dr.~Munch]{Prof.~Elizabeth Munch. Substitute: Rachel Roca}
...
\includegraphics[align = c, width = \textwidth]{Day01-Schedule-Test3}
...
\column{.45\textwidth}
\centering
\includegraphics[align = c, width = \textwidth]{SVM-Example}
...
\column{.4\textwidth}
\centering
\includegraphics[align = c, width = \textwidth]{SVM-example-WithLine1}

\column{.4\textwidth}
\centering
\includegraphics[align = c, width = \textwidth]{SVM-example-WithLine2}
\end{columns}
\end{frame}
%--- Next Frame ---%
...
\bvfill
\href{https://www.desmos.com/calculator/lqms253gfq}{desmos.com/calculator/lqms253gfq}
\end{frame}
}
%--- Next Frame ---%
{
...
%   \item Plug in $(0,0)$. For mine, this means that positive is below the line and negative is above. 
%   \item Note that if they find the equation $-X_1  -X_2 -4 = 0 $, the sides are reversed. 
}
...
\begin{frame}[t]{Next time}
	...
	\includegraphics[align = c, width = .45\textwidth]{Day01-Schedule-Test3}
