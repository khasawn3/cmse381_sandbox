...
\begin{frame}[c]{Real-world example: Chekroud et al., Science 383, 164–167 (2024) }
	\centering
	\includegraphics[width=0.7\textwidth]{illusory_generalizability_science2024_1.png}
...
\begin{frame}[c]{Real-world example: Chekroud et al., Science 383, 164–167 (2024) }
	\centering
	\includegraphics[width=0.95\textwidth]{illusory_generalizability_science2024_2.png}
...
\begin{frame}[c]{Polynomial regression}
	...
	Test your understanding: \href{https://PollEv.com/multiple_choice_polls/j44HHKj3HegKkZGrNhfnj/respond}{PollEv}
	\end{columns}
\end{frame}
%--- Next Frame ---%
