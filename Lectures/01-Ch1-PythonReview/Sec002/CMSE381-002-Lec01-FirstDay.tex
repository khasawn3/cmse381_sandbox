...
\author[Dr.~K]{Prof.~Firas Khasawneh}
...
\begin{columns}
	\column{.4\textwidth}
	\centering
\includegraphics[alt={personal photo of firas khasawneh},width = .4\textwidth]{firas_khasawneh}
...
Associate Professor, CMSE, MSU\\
	...
	\column{.4\textwidth}
	\centering
\includegraphics[alt={personal photo of Haishen Dai},width = .35\textwidth]{Haishen_Dai}
...
\begin{frame}{D2L and where to find grades}
	\centering 
	\url{https://d2l.msu.edu/d2l/home/2387928}
\includegraphics[alt={screenshot of course page on D2L},width=.7\textwidth]{D2L_s26_002.png} 
\end{frame}
%--- Next Frame ---%
...
\includegraphics[alt={screenshot of course website},width=.8\textwidth]{coursewebsite_s26.png}
...
\begin{frame}[c]{Crowdmark and where we grade your quizzes/midterms}
	\centering
	No URL: You will get an automated email from the system (and see it in your account)
...
\column{.4\textwidth}
\centering
\textit{Dr.~K} (Starting 1/20)

 \vspace{.1in}

 MWF 1:40 pm - 2:00 pm (In-person, EB2400)\\
 \hspace{0.1in} Tue: 1:30-2:30 (Zoom) https://msu.zoom.us/j/98717159065 \\
