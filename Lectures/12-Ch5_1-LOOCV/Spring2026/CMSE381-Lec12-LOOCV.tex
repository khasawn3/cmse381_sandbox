...
\column{.45\textwidth}
\centering
\includegraphics[alt={Screenshot of the course schedule from lectures 11 to 20.},width=\textwidth]{Schedule-S26-Lecs11_to_20}
...
\begin{frame}[c]{Throw-back}
	...
	\centering
	\includegraphics[alt={Plot on left is scatter plot for simulated close to linear data with three different fits of varying flexibility. Plot on right shows the training and testing MSE as a function of flexibility},width = .8\textwidth]{Fig2-10}
...
\centering
\includegraphics[alt={Prediction error versus model complexity. One curve shows the training sample error, while another curve shows the test sample error.},width = .7\textwidth]{ModelTradeoffs.png}
\begin{columns}
\column{.45\textwidth}
\centering
...
\includegraphics[alt={A horizontal bar representing data points with random chunks colored as either red (training set) or yellow (test set).},width = \textwidth]{CV-subset0}
...
\includegraphics[alt={A horizontal bar representing data points with random chunks colored as either red (training set) or yellow (test set).},width = \textwidth]{CV-subset0}
\includegraphics[alt={A horizontal bar representing data points with random chunks colored as either red (training set) or yellow (test set).},width = \textwidth]{CV-subset1}
\includegraphics[alt={A horizontal bar representing data points with random chunks colored as either red (training set) or yellow (test set).},width = \textwidth]{CV-subset2}
\includegraphics[alt={A horizontal bar representing data points with random chunks colored as either red (training set) or yellow (test set).},width = \textwidth]{CV-subset3}
\includegraphics[alt={A horizontal bar representing data points with random chunks colored as either red (training set) or yellow (test set).},width = \textwidth]{CV-subset4}
\begin{columns}
\column{.45\textwidth}
\centering
...
\column{.45\textwidth}
\centering
\includegraphics[alt={Mean squared error versus degree of polynomial. Multiple curves corresponding to different validation sets are shown.
},width = \textwidth]{Fig5-2b}
\column{.45\textwidth}
\centering
\InstructorList{
...
\begin{frame}[c]{The idea}
	\centering
\includegraphics[alt={A horizontal bar representing data points with a yellow square (test set) at the zeroth position of the bar with the rest of the bar red (training set)},width = \textwidth]{LOOCV-subset0.png}
\includegraphics[alt={A horizontal bar representing data points with a yellow square (test set) at the first position of the bar with the rest of the bar red (training set)},width = \textwidth]{LOOCV-subset1.png}
\includegraphics[alt={A horizontal bar representing data points with a yellow square (test set) at the second position of the bar with the rest of the bar red (training set)},width = \textwidth]{LOOCV-subset2.png}
\includegraphics[alt={A horizontal bar representing data points with a yellow square (test set) at the third position of the bar with the rest of the bar red (training set)},width = \textwidth]{LOOCV-subset3.png}
\includegraphics[alt={A horizontal bar representing data points with a yellow square (test set) at the fourth position of the bar with the rest of the bar red (training set)},width = \textwidth]{LOOCV-subset4.png}
$\vdots$
\includegraphics[alt={A horizontal bar representing data points with a yellow square (test set) at last, rightmost position of the bar with the rest of the bar red (training set)},width = \textwidth]{LOOCV-subset29.png}
\begin{columns}
\column{.45\textwidth}
\centering
...
\begin{frame}[t]{Again example with \texttt{auto} data}
	...
	\column{.45\textwidth}
	\centering
	\includegraphics[alt={Mean squared error versus degree of polynomial for LOOCV.},align = c, width = \textwidth]{Fig5-4a}
...
\begin{frame}[t]{Next time}
	...
	\includegraphics[alt={Screenshot of the course schedule from lectures 11 to 20.
},align = c, width = .65\textwidth]{Schedule-S26-Lecs11_to_20}
