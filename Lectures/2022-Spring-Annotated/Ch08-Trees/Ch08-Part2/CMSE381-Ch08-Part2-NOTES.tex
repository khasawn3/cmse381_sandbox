...
\begin{frame}[t]{Recall: The bootstrap}
...
\textbf{Idea:} Build separate models from independent training sets, and average resulting predictions:
\begin{itemize}
...
\begin{frame}[t]{Tree version}
	\centering
\includegraphics[width = .6\textwidth]{TreeBaggingCartoon}
