...
\textbf{Announcements:}
	\begin{itemize}
	\item No more homework!
	\item Weds: Project office hours, zoom only, send a message on slack!
	\item Mon Dec 2: Review - Bring questions!
	\item Weds Dec 4: Exam
	\begin{itemize}
		\item Content since 2nd Exam (Ch 7 and on)
		\item One page (8.5x11) handwritten cheat sheet
		\item Calculator if you want it
	\end{itemize}
	\end{itemize}
...
\centering
	...
	\includegraphics[align = c, width = \textwidth]{Day01-Schedule-Test3.png}
