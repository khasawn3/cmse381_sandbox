...
\item By eye: green line is the direction of most variability, calle dthe principal component
...
\column{.45\textwidth}
\centering
\url{https://www.desmos.com/calculator/qq14tyjz0z}
\column{.45\textwidth}
\centering
\InstructorNotes{
There is something broken with the PC2 part of this tool.  Perhaps consider fixing it up for next year.
}
\end{columns}
