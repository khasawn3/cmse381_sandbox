...
\column{.5\textwidth}
\centering
    \includegraphics[alt={Screenshot of the course schedule for lectures 11 to 20.},width=0.8\textwidth]{Schedule-S26-Lecs11_to_20}
\end{columns}
...
\column{.4\textwidth}
\centering
\includegraphics[alt={Diagram illustrating the geometric constraint used in ridge regression.},width = \textwidth]{Fig6-4}
\column{.4\textwidth}
\centering

\includegraphics[alt={Diagram illustrating the geometric constraint used in lasso regression.},width = \textwidth]{Fig6-6}
\end{columns}
...
\column{.45\textwidth}
\centering
\includegraphics[alt={Diagram illustrating projection of a point onto a line as a geometric interpretation of dimensionality reduction.},align = c, width = \textwidth]{DimReduction_Projection.png}
...
% \begin{frame}[c]{Projection onto a line}
	...
	\column{.3\textwidth}
	\centering
	\includegraphics[alt={Diagram showing different projections of data points onto a line in a dimensionality reduction example.},align = c, width = \textwidth]{DimReduction_Projection_Example2.png}
	% DimReduction_Projection_Example2_linecolor.png 
	% DimReduction_Projection_Example2_line.png
	\column{.55\textwidth}
	\centering
	\includegraphics[alt={First projection example in a dimensionality reduction illustration.},align = c, width = .49\textwidth]{DimReduction_Projection_Example2_157.png}
    \includegraphics[alt={Second projection example in a dimensionality reduction illustration.},align = c, width = .49\textwidth]{DimReduction_Projection_Example2_235.png}
    \includegraphics[alt={Third projection example in a dimensionality reduction illustration.},align = c, width = .49\textwidth]{DimReduction_Projection_Example2_78.png}
    \includegraphics[alt={Fourth projection example in a dimensionality reduction illustration.},align = c, width = .49\textwidth]{DimReduction_Projection_Example2_0.png}
	\end{columns}
	\end{frame}
	%--- Next Frame ---%
	...
	\begin{columns}
	\column{.24\textwidth}
	\includegraphics[alt={First projection example in a dimensionality reduction illustration.},align = c, width = \textwidth]{DimReduction_Projection_Example2_157.png}
    \includegraphics[alt={Histogram of projected z values for the first projection example.},align = c, width = \textwidth]{DimReduction_Projection_Example2_hist157.png}
	
	\column{.24\textwidth}
	\includegraphics[alt={Second projection example in a dimensionality reduction illustration.},align = c, width = \textwidth]{DimReduction_Projection_Example2_235.png}
    \includegraphics[alt={Histogram of projected z values for the second projection example.},align = c, width = \textwidth]{DimReduction_Projection_Example2_hist235.png}

	\column{.24\textwidth}
	\includegraphics[alt={Third projection example in a dimensionality reduction illustration.},align = c, width = \textwidth]{DimReduction_Projection_Example2_78.png}
    \includegraphics[alt={Histogram of projected z values for the third projection example.},align = c, width = \textwidth]{DimReduction_Projection_Example2_hist78.png}

	\column{.24\textwidth}
	\includegraphics[alt={Fourth projection example in a dimensionality reduction illustration.},align = c, width = \textwidth]{DimReduction_Projection_Example2_0.png}
    \includegraphics[alt={Histogram of projected z values for the fourth projection example.},align = c, width = \textwidth]{DimReduction_Projection_Example2_hist0.png}
	\end{columns}
	\end{frame}
	%--- Next Frame ---%
...
\column{.45\textwidth}
\centering
\includegraphics[alt={Scatter plot of an example dataset with two input variables and a line showing the principal component direction of greatest variability.},width = \textwidth, align = c]{Fig6-14}
\column{.45\textwidth}
\centering
\InstructorList{
...
\begin{frame}[c]{Projection onto first PC}
	...
	\centering
	\includegraphics[alt={Scatter plot showing an example dataset projected onto the first principal component, with the principal component direction and the mean point indicated.},width = .6 \textwidth, align = c]{Fig6-15a}
...
\column{.45\textwidth}
\centering
\includegraphics[alt={Scatter plot showing an example dataset projected onto the first principal component, with the principal component direction and the mean point indicated.},width = \textwidth, align = c]{Fig6-15a}
\column{.45\textwidth}
\centering
\InstructorList{
...
\includegraphics[alt={Diagram illustrating principal component scores obtained by projecting observations onto the first principal component direction.},width = \textwidth, align = c]{Fig6-16}
\begin{columns}
\column{.45\textwidth}
\centering
\begin{equation*}
...
\centering
\includegraphics[alt={Rotated view of the example dataset showing observations in relation to the first principal component and their principal component scores.},width = .8\textwidth, align = c]{Fig6-15}
\begin{columns}
\column{.45\textwidth}
\centering
\InstructorList{
...
\end{itemize}
\includegraphics[alt={Scatter plot showing an example dataset projected onto the first principal component, with the principal component direction and the mean point indicated.},width = .5\textwidth, align = c]{Fig6-15a}
