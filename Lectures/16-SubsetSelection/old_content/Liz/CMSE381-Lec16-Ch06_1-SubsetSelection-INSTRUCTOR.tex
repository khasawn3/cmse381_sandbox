...
\textbf{Announcements:}
	\begin{itemize}
		\item HW \#4 Due Tonight!
	\end{itemize}
\column{.45\textwidth}
\includegraphics[align = c, width = \textwidth]{Day01-Schedule-Test2}
\centering
...
%==========
\begin{frame}[c]{Too many variables}
...
\end{itemize}
\end{columns}
\InstructorNotes{The game: fit the model $2^n$ times, score each, pick one with best score}
\end{frame}
%--- Next Frame ---%
