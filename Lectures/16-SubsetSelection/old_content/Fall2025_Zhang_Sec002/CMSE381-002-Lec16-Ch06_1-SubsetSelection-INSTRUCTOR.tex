...
\textbf{Announcements:}
	\begin{itemize}
		...
		\item HW \#5 due very late, to avoid Fall break weekend. I will release it early so you can work on it to prep for the exam. 
	\end{itemize}
\column{.45\textwidth}
...
\end{columns}
\vfill
Test your understanding: \href{https://PollEv.com/multiple_choice_polls/BZSEDYtwmgzceGBfApMHC/respond}{PollEv}
\end{frame}
%--- Next Frame ---%
% %----------------
