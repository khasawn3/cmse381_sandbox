...
\begin{frame}[c]{Announcements}
	...
	\textbf{Announcements:}
	\begin{itemize}
		\item Homework \#3 Due Sunday Sep 21
		\item Next Monday - Review day
		\begin{itemize}
			\item depends on what you ask! 
			\item Submit your questions \href{https://forms.office.com/r/NCrYt7B8hk}{Here}
		\end{itemize}
		\item Wed 9/24 - Exam \#1 
		\begin{itemize}
...
\begin{frame}[t]{The game }
	...
	\centering
	\includegraphics[width = \textwidth]{Fig2-13.png}
	Test your understanding: \href{https://PollEv.com/multiple_choice_polls/3uFsHVAocmUaGCYAc4Ynm/respond}{PollEv}
	\end{columns}
\end{frame}
%--- Next Frame ---%
