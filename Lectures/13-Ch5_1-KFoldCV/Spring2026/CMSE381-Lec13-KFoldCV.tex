...
\title[]{Ch 5.1.1-3: Leave one out and $k$-Fold Cross-Validation}
...
\begin{frame}[c]{Throw-back}
	...
	\centering
	\includegraphics[alt={Throwback slide showing a figure labeled Fig2-10 from earlier lecture material.},width = .8\textwidth]{Fig2-10}
...
\centering
\includegraphics[alt={Diagram showing tradeoffs among different statistical models.},width = .7\textwidth]{ModelTradeOffs.png}
\begin{columns}
\column{.45\textwidth}
\centering
...
\includegraphics[alt={Diagram showing how data are split in the validation set approach.},width = \textwidth]{CV-subset0}
...
\column{.45\textwidth}
\centering
\includegraphics[alt={Diagram showing one split of the data into a training set and a validation set.},width = \textwidth]{Fig5-2a}
\column{.45\textwidth}
\centering
...
\includegraphics[alt={Diagram showing the first data split in the validation set approach.},width = \textwidth]{CV-subset0}
\includegraphics[alt={Diagram showing the second data split in the validation set approach.},width = \textwidth]{CV-subset1}
\includegraphics[alt={Diagram showing the third data split in the validation set approach.},width = \textwidth]{CV-subset2}
\includegraphics[alt={Diagram showing the fourth data split in the validation set approach.},width = \textwidth]{CV-subset3}
\includegraphics[alt={Diagram showing the fifth data split in the validation set approach.},width = \textwidth]{CV-subset4}
\begin{columns}
\column{.45\textwidth}
\centering
...
\column{.45\textwidth}
\centering
\includegraphics[alt={Diagram showing a different training and validation split, illustrating that the validation set approach can produce different results across splits.},width = \textwidth]{Fig5-2b}
\column{.45\textwidth}
\centering
\InstructorList{
...
\begin{frame}[c]{The idea}
	\centering
\includegraphics[alt={Diagram showing the first leave-one-out cross-validation split, where one observation is held out for validation and the rest are used for training.},width = \textwidth]{LOOCV-subset0.png}
\includegraphics[alt={Diagram showing the second leave-one-out cross-validation split, where a different observation is held out for validation.},width = \textwidth]{LOOCV-subset1.png}
\includegraphics[alt={Diagram showing the third leave-one-out cross-validation split, where a different observation is held out for validation.},width = \textwidth]{LOOCV-subset2.png}
\includegraphics[alt={Diagram showing the fourth leave-one-out cross-validation split, where a different observation is held out for validation.},width = \textwidth]{LOOCV-subset3.png}
\includegraphics[alt={Diagram showing the fifth leave-one-out cross-validation split, where a different observation is held out for validation.},width = \textwidth]{LOOCV-subset4.png}
$\vdots$
\includegraphics[alt={Diagram showing the final leave-one-out cross-validation split, where the last observation is held out for validation.},width = \textwidth]{LOOCV-subset29.png}
\begin{columns}
\column{.45\textwidth}
\centering
...
\begin{frame}[t]{Again example with \texttt{auto} data}
	...
	\column{.45\textwidth}
	\centering
	\includegraphics[alt={Figure using the auto data example to show a fixed result with no randomness across repeated runs.},align = c, width = \textwidth]{Fig5-4a}
...
\includegraphics[alt={Figure from the auto data example.},width = \textwidth, align = c]{Fig5-4a}
\column{.3\textwidth}
\centering
\includegraphics[alt={Second figure from the auto data example.},width = \textwidth, align = c]{Fig5-4b}
\column{.3\textwidth}
\centering 
\textbf{\tiny Validation set}\\
\includegraphics[alt={Figure labeled validation set for comparison.},width = \textwidth]{Fig5-2b}
\end{columns}
